...
class FreemindPlugin extends MantisPlugin {
	...
	function register( ) {
		...
		$this->author = 'Peter Tandler, teambits GmbH, Victor Boctor';
		$this->contact = 'vboctor@gmail.com';
	...
	function export_issues_menu( ) {
		return array(
			...
			'<a href="' . plugin_page( 'browse' ) . '" target="_blank">' . plugin_lang_get( 'browse' ) . '</a>',
			);
	}
}
